...
하트 5(30분당 1 재생) · XP(레벨=100당 1) · 보석 · 스트릭+프리즈 · 더블XP부스트 · 일일퀘스트 3종 · 주간 리그(결정적 봇: `weekStart` 시드) · 배치고사(섹션별 2문제, 전 섹션 통과시 C1 배치) · 약점 복습(`weakPairs`: 문장 en 키 miss 카운트, 정답 시 감소) · 레전더리(완료 유닛 복습을 무실수 재클리어) · 통화 XP(교환당 2).
